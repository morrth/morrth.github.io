...
live2d_settings['waifuMinWidth']        = '700px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
live2d_settings['waifuEdgeSide']        = 'left:80vw';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['aboutPageUrl']         = 'https://morrth.top/';   // 关于页地址, '{URL 网址}'
